    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<GameHubContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString("GameHubDatabase")));

            services.AddTransient<IDataContextProvider, DataContextProvider>();
            services.AddTransient<IApiHelperTrace, EFApiHelperTrace>();
